    ...
    <article className="rounded-[24px] bg-[#DBDBDBB2] px-[36px] pb-[20px] pt-[32px]">
      <header className="mb-[13px]">
        <div className="mb-[7px] flex flex-row gap-x-[18px]">
          ...
          <time className="text-[7.5px] leading-[135%] text-[#989898]">
        ...
        <h2 className="text-[13.4px] leading-[135%] text-[#373737]">{post.title}</h2>
      </header>

      {post.excerpt && (
        <p className="mb-[14px] text-[11px] leading-[135%] text-[#989898]">{post.excerpt}</p>
      )}

      {post.body && (
        <div className="text-[11px] leading-[135%] text-[#373737]">
          <PortableText
            value={post.body}
            components={{
              block: {
                ...
                image: ({ value }: any) => {
                  ...
                  return (
                    <div className="mb-[14px]">
                      ...
                      {value.caption && (
                        <p className="mt-[4px] text-left text-[7.5px] leading-[135%] text-[#989898]">
                          {value.caption}
                        </p>
                      )}
                    </div>
