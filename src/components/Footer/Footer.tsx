    ...
    >
      <div className="mx-auto flex w-[375px] flex-col hover:cursor-pointer">
        <form onSubmit={handleSubmit} className="flex flex-col">
          <div
            className={`${getAnimationClass()} ${pathname.includes("journal") && width && width > 640 && getPositionClass()} mx-auto flex flex-row justify-between rounded-[24px] shadow-[0px_4px_4px_rgba(0,0,0,0.04),0px_0px_1px_rgba(249,249,249)] ${isSubmitted ? "bg-[#6C6C6C80]" : "bg-[#DBDBDB99]"} h-[46px] px-[30px] text-[11px] ${isSubmitted ? "text-[#F8F8F8]" : "text-[#A6A6A6]"} transition-all duration-500 ease-in-out ${
