  ...
  return (
    <div className="fixed z-40 mt-[34px] flex w-screen flex-row justify-between gap-x-[5px] px-[24px] sm:px-[60px]">
      {showInfo ? (
        ...
        <div className="drop-shadow-xs flex rounded-[24px] bg-[#DBDBDBB2] text-[#373737] shadow-[0px_4px_4px_rgba(0,0,0,0.04),0px_0px_1px_rgba(249,249,249)] backdrop-blur-[64px] transition-colors duration-500 hover:bg-[#BCBCBCB2] hover:text-[#373737]">
          <button
          ...
          >
            <div className="flex flex-col items-center gap-y-[8px]">
              <button
                ...
                className="relative flex h-[33px] w-[94.22px] items-center rounded-[24px] bg-white bg-opacity-80 px-3 text-center text-[#373737] shadow-[0px_4px_4px_rgba(0,0,0,0.04),0px_0px_1px_rgba(249,249,249)] backdrop-blur-[5px] transition-opacity duration-300 hover:opacity-80"
              >
              ...
              {navItems.map((item) => (
                <TransitionLink
                  key={item.path}
                  href={item.path}
                  className="relative flex h-[33px] w-[94.22px] items-center rounded-[24px] bg-white bg-opacity-80 px-3 text-center text-[#373737] no-underline shadow-[0px_4px_4px_rgba(0,0,0,0.04),0px_0px_1px_rgba(249,249,249)] backdrop-blur-[5px] transition-opacity duration-300 hover:opacity-80"
                >
      ...
      >
        {navItems.map((item) => (
          <TransitionLink
            ...
            className={`drop-shadow-xs relative z-10 w-[74px] rounded-[24px] bg-[#DBDBDBB2] py-[10px] text-center text-[#373737] no-underline shadow-[0px_4px_4px_rgba(0,0,0,0.04),0px_0px_1px_rgba(249,249,249)] backdrop-blur-[64px] transition-colors duration-500 first:ml-[5px] hover:bg-[#BCBCBCB2] hover:text-[#373737]`}
          >
            <span>{item.name}</span>
          </TransitionLink>
        ))}
